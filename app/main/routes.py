...
def index():
    ...
    return render_template('index.html', title='Домой', form=form,
...
def explore():
    ...
    prev_url = url_for('main.explore', page=posts.prev_num) \
        if posts.has_prev else None
    return render_template('index.html', title='Обсуждение', posts=posts.items,
...
def send_message(recipient):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash(_('Ваше сообщение отправлено.'))
